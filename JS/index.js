...
clickableText.addEventListener( 'click', function () {
  window.location.href = 'HTML/Order.html'; // Replace 'next.html' with the URL of your next page
} );
...
clickableText.addEventListener( 'click', function () {
  window.location.href = 'HTML/Report.html'; // Replace 'next.html' with the URL of your next page
} );
